...
This runs the interactive scaffolding script. For the full procedural guide (including manual steps), see `.agents/skills/generate-new-genx-feature/SKILL.md`.
