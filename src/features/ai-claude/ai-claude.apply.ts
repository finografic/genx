...
/**
 * Apply Claude Code support using `previewAiClaude` + `applyPreviewChanges`. `.claude/assets/` is represented
 * in preview as `.claude/assets/.gitkeep` when the directory is missing.
 */
