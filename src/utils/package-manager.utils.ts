...
/**
 * Return a shallow copy of a string-keyed record with keys sorted A→Z. Use when adding entries to
 * `devDependencies` / `dependencies` so the written package.json stays consistently ordered.
 */
